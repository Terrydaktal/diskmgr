...
def main():
    ...
    readme_content += "|   |-- common.py              # Shared constants, process, device, and SMART helpers\n"
    ...
    readme_content += "|       |-- filesystem.py      # defrag, format, conversion, and scrub\n"
    ...
    readme_content += "- **Description**: The executable wrapper delegates to a composed interactive shell. Shared runtime behavior lives in `common.py` and `shell_helpers.py`; command groups live under `diskmgrlib/commands/`.\n"
